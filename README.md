...
- **Temperature/sampling playground**: the same question and prompt, run once per `temperature` value (`0.0`, `0.7`, `1.2` by default) — determinism vs. creativity, live instead of asserted.
